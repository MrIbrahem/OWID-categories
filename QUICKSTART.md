...
python src/run_countries.py --dry-run --files-per-item 1

# Test with 2 countries, 1 file each
python src/run_countries.py --dry-run --limit 2 --files-per-item 1
```
...
python src/run_countries.py --limit 10 --files-per-item 2

# Process all countries, 1 file per country (conservative)
python src/run_countries.py --files-per-item 1
...
python src/run_countries.py --dry-run --limit 3 --files-per-item 2
```
...
python src/run_countries.py --dry-run --limit 1 --files-per-item 1
...
python src/run_countries.py --limit 5 --files-per-item 1
